...
class Trans_UHET():
    def main(self, Planilha, data1, data2, mes, ano):
        def obter_valores():
            ...
            codigos = [813, 817, 812, 796, 808, 797, 814, 800, 799, 803,
                       815, 811, 801, 806, 816, 818, 805, 809, 798, 807, 804, 802]
            ...
            consulta_sql = "SELECT codigo_sec, COUNT(hora_transmissao) FROM mensagens WHERE Codigo_Sec IN (813, 817, 812, 796, 808, 797, 814, 800, 799, 803, 815, 811, 801, 806, 816, 818, 805, 809, 798, 807, 804, 802) \
